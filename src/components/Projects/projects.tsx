...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'A social platform for volunteers and event organizers to connect. (Over 20,000 active users)',
    github: '',
    live: 'https://myvoluntier.com',
    stack: 'Laravel + MySQL + Bootsrap + jQuery + Twillo + AWS',
    isPrivate: true,
    isLive: true,
  },
  {
  ...
  {
    id: uuid(),
    title: 'Vue App Collection',
    description: 'A collection of apps made with vue3 and other techs like tailwindCSS, & firebase',
    github: 'https://github.com/goldenglorys/vue-app-collection',
    live: 'https://vue-apps.netlify.app/',
    stack: 'JavaScript',
    isPrivate: false,
    isLive: true,
  },
  ...
  },
  {
    id: uuid(),
    title: 'ISS Tracker ',
    description: 'A simple program that provides real-time tracking of the International Space Station (ISS)',
    github: 'https://github.com/goldenglorys/iss-tracker',
    live: '',
    stack: 'Python',
    isPrivate: false,
    isLive: false,
