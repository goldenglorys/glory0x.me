...
export default function Resume(props: ResumeProp) {
  ...
  return (
    <div className="resume">
      <Helmet title="My Resume" name="Glory Olusola Resume" content="Glory Olusola - Software Engineer Resume" />
      <div className="resume_container">
        <div className="top_row">
          <h2>{resume.name}</h2>
          <div className="buttons">
            <a
              href="https://drive.google.com/file/d/1nFowE4nr1JF_N_eDe-64XbA-LfdGI1Ac/view?usp=sharing"
              target="_blank"
